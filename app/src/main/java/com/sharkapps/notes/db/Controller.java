...
public class Controller {
	...
	/**
	 * Reads all memento or categories from database
	 ...
	 * @param sortId the sort id of categories or memento
	 * @param <T> a type which extends DatabaseModel
	 * @return a list of memento or categories
	 */
	 ...
	 * @param ids a list of the memento' IDs
