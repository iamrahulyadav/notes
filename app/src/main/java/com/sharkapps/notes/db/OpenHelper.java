package com.sharkapps.notes.db;
...
public class OpenHelper extends SQLiteOpenHelper {
	...
	public static final String TABLE_NOTES = "memento";
	...
	public void onCreate(SQLiteDatabase db) {
		// Main table to store memento and categories
		db.execSQL(
		...
		// A trigger to empty UNDO table, add restoring sql query to UNDO table, then delete all child memento before deleting the parent note
		db.execSQL(
